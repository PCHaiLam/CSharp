...
namespace BaiTap1_63134417.Controllers
{
    public class PhepToan_63134417Controller : Controller
    {
        // GET: PhepToan_63134417
        //************************************************************************************************//
        //lần 1: để hiển thị trang khi lần đầu tải trang
        public ActionResult UseRequest()
        {
            return View();
        }
        //lần 2: sau khi nhập dữ liệu, sẽ hiển thị form kèm kết quả
        [HttpPost]

...
namespace BaiTap3_63134417.Controllers
{
    public class NhanVien_63134417Controller : Controller
    {
        // GET: NhanVien_63134417
        public ActionResult Index()
        {
            return View();
        }
        [HttpPost]
        public ActionResult Index(HttpPostedFileBase Avatar, model emp)
        {
        ...
        public ActionResult Confirm(model emp)
        {
            return View();
